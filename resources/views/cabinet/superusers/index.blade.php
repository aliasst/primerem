...
@section('title', 'Список главных админов')
        ...
        <div class="row">
            ...
            <div class="col-12">
                            ...
                            @foreach($users as  $user)
                                ...
                                <tr class="">
                                    <td aria-label="Имя"><a style="white-space: nowrap" class="btn-link"
                                                                        href="{{route ('cabinet.superuser.edit', $user->id)}}">{{ $user->name}}</a>
                                    </td>
                ...
                <div class="text-center">
                    <a href="{{route('cabinet.superuser.create')}}"
